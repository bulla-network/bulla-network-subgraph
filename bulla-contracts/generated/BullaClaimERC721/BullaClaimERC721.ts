...
export class BullaManagerSet extends ethereum.Event {
  get params(): BullaManagerSet__Params {
    return new BullaManagerSet__Params(this);
  }
}

export class BullaManagerSet__Params {
  _event: BullaManagerSet;

  constructor(event: BullaManagerSet) {
    this._event = event;
  }

  get prevBullaManager(): Address {
    return this._event.parameters[0].value.toAddress();
  }

  get newBullaManager(): Address {
    return this._event.parameters[1].value.toAddress();
  }
...
export class BullaClaimERC721__createClaimInputAttachmentStruct extends ethereum.Tuple {
  get hash(): Bytes {
    return this[0].toBytes();
  }
...
export class BullaClaimERC721__createClaimWithURIInputAttachmentStruct extends ethereum.Tuple {
  get hash(): Bytes {
    return this[0].toBytes();
  }
...
export class BullaClaimERC721__getClaimResultValue0Struct extends ethereum.Tuple {
  get claimAmount(): BigInt {
    return this[0].toBigInt();
  }
  ...
  get attachment(): BullaClaimERC721__getClaimResultValue0AttachmentStruct {
    return changetype<BullaClaimERC721__getClaimResultValue0AttachmentStruct>(
      this[6].toTuple()
    );
  }
}

export class BullaClaimERC721__getClaimResultValue0AttachmentStruct extends ethereum.Tuple {
  get hash(): Bytes {
    return this[0].toBytes();
  }
...
export class BullaClaimERC721 extends ethereum.SmartContract {
  static bind(address: Address): BullaClaimERC721 {
    return new BullaClaimERC721("BullaClaimERC721", address);
  }
  ...
  bullaManager(): Address {
    let result = super.call("bullaManager", "bullaManager():(address)", []);

    return result[0].toAddress();
  }

  try_bullaManager(): ethereum.CallResult<Address> {
    let result = super.tryCall("bullaManager", "bullaManager():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  createClaim(
    ...
    dueBy: BigInt,
    claimToken: Address,
    attachment: BullaClaimERC721__createClaimInputAttachmentStruct
  ): BigInt {
  ...
  createClaimWithURI(
    ...
    dueBy: BigInt,
    claimToken: Address,
    attachment: BullaClaimERC721__createClaimWithURIInputAttachmentStruct,
    _tokenUri: string
  ): BigInt {
    let result = super.call(
      "createClaimWithURI",
  ...
  getClaim(tokenId: BigInt): BullaClaimERC721__getClaimResultValue0Struct {
    let result = super.call(
      "getClaim",
    ...
    return changetype<BullaClaimERC721__getClaimResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getClaim(
    tokenId: BigInt
  ): ethereum.CallResult<BullaClaimERC721__getClaimResultValue0Struct> {
    let result = super.tryCall(
      "getClaim",
      "getClaim(uint256):((uint256,uint256,uint8,uint256,address,address,(bytes32,uint8,uint8)))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<BullaClaimERC721__getClaimResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
...
export class SetBullaManagerCall extends ethereum.Call {
  get inputs(): SetBullaManagerCall__Inputs {
    return new SetBullaManagerCall__Inputs(this);
  }

  get outputs(): SetBullaManagerCall__Outputs {
    return new SetBullaManagerCall__Outputs(this);
  }
}

export class SetBullaManagerCall__Inputs {
  _call: SetBullaManagerCall;

  constructor(call: SetBullaManagerCall) {
    this._call = call;
  }

  get _bullaManager(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetBullaManagerCall__Outputs {
  _call: SetBullaManagerCall;
